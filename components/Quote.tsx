...
const Quote = () => {
  ...
  return (
    <div className={SourceSerif4.className}>
      <section
        id='Quote'
        className=' h-[50vh]  relative w-screen overflow-hidden border-y-2 group  flex flex-col  justify-center z-0'>
        ...
        <div className='text-center px-6 '>
          <div className={`mt-8 flex flex-col items-center justify-between`}>
            ...
            <Image
              ...
              aria-hidden='true'
              loading='lazy'
              className='object-cover grayscale-75 group-hover:grayscale-0 transition-all duration-500 ease-linear-z-30'
            />
            {/* Glassmorphism Quote */}
            <div
